		...
		<Section type={SectionType.default}>
			<Panel className={"col-span-full"}
				header={<>
					...
					<Heading text={"Создать группу"} variant={HeadingVariant.h4} className={'!mb-0 inline-block'} color={HeadingColor.accent}/>
				...
				footer={<div className={'accounts-group_header gap-4 text-[#606163] grid grid-cols-[1.25fr_2fr] grid- font-medium'}>
					...
					<div className={'flex justify-end gap-5'}>
						...
						<Button text={'Сохранить'} action={() => {
							store.permissionStore.createPermissionStoreAdmin(changes)
							navigate(-1)
