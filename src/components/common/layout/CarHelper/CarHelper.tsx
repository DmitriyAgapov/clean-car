...
const CarHelper = ():JSX.Element => {
	const headerValues = ['Шиномонтаж', 'Мойка', 'Эвакуация']
	...
	return (
		<Panel  background={PanelColor.glass} headerClassName={' contents'} bodyClassName={' contents'} variant={PanelVariant.withPaddingSmWithBody} header={<Header/>} className={'grid overflow-hidden grid-cols-4 gap-2.5 !bg-gray-2/20 carHelper  pb-10 !border-accent !border'}>
