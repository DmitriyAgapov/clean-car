    ...
    <Section type={SectionType.default}>
      <Panel
        ...
        header={<>
          ...
          {store.appStore.appType === "admin" && <> <Button text={'Скачать шаблон'} variant={ButtonVariant["accent-outline"]} href={'/account/cars/create'} className={'inline-flex mr-5'} size={ButtonSizeType.sm} />
