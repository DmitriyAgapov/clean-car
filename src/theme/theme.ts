import { createTheme,  Input,Combobox, Select, DEFAULT_THEME, mergeMantineTheme, } from '@mantine/core'
...
//             background: 'hover:transparent focus:transparent',
//             opacity: 'hover:bg-opacity-100 focus:bg-opacity-100',
//             userSelect: 'select-none',
//             color: 'hover:text-accent focus:text-accent',
//             outline: 'outline outline-0',
//             transition: 'transition-all',
//           },
//           active: {
//             fontSize: 'font-2xl',
//             bg: 'hover:transparent focus:transparent',
